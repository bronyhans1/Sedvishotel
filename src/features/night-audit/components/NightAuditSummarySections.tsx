        ...
        <Card>
          ...
          <CardContent className="space-y-3 text-sm">
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="font-semibold">{formatCurrency(snapshot.vatCollected)}</span>
            </div>
            <div className="flex items-center justify-between">
              <span className="text-muted-foreground">VAT Exempt Revenue</span>
              <span className="font-semibold">{formatCurrency(snapshot.vatExemptRevenue)}</span>
            </div>
            <div className="flex items-center justify-between">
              <span className="text-muted-foreground">VAT Overrides</span>
              <span className="font-semibold">{snapshot.vatOverrideCount}</span>
            </div>
          </CardContent>
        </Card>
