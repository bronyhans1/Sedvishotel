    ...
    <PageContainer title="Reports" description={`Analytics and exports for ${siteConfig.name}.`}>
      ...
      <Card id="payments">
        ...
        <CardContent className="space-y-4">
          ...
          <p className="text-sm">VAT Collected: <strong>{formatCurrency(data.payments.vatCollected)}</strong></p>
          <p className="text-sm">VAT Exempt Revenue: <strong>{formatCurrency(data.payments.vatExemptRevenue)}</strong></p>
