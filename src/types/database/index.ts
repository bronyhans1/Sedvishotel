...
export interface Database {
  public: {
    Tables: {
      ...
      products: { Row: import("@/types/database/tables").DbProduct };
      stock_movements: {
        Row: import("@/types/database/tables").DbStockMovement;
      };
      sales: { Row: import("@/types/database/tables").DbSale };
      sale_items: { Row: import("@/types/database/tables").DbSaleItem };
      sale_payments: { Row: import("@/types/database/tables").DbSalePayment };
      guest_folios: { Row: import("@/types/database/tables").DbGuestFolio };
      folio_entries: { Row: import("@/types/database/tables").DbFolioEntry };
