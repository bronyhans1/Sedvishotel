...
export const ActivityActionCodes = {
  ...
  RESERVATION_OVERSTAY_CHARGE_CREATED: "reservation.overstay_charge_created",
  RESERVATION_OVERSTAY_CHARGE_POSTED: "reservation.overstay_charge_posted",
  RESERVATION_OVERSTAY_APPROVED: "reservation.overstay_approved",
  ...
  CORRECTION_SESSION_REVIEW: "correction_session.review",
  ...
  NIGHT_AUDIT_RECLOSED: "night_audit.reclosed",
  NIGHT_AUDIT_CASH_VARIANCE: "night_audit.cash_variance",
  BUSINESS_DATE_ADVANCED: "business_date.advanced",
  BUSINESS_DATE_REOPENED: "business_date.reopened",
