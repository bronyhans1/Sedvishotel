...
export const defaultHotelSettings: HotelSettings = {
  ...
  overstayChargeMode: "none",
  overstayManagerApprovalRequired: false,
  overstayAllowManualWaiver: true,
  overstayAutoCreatePendingCharge: true,
  overstayNightAuditMode: "acknowledge",
  currency: "GHS",
  currencySymbol: "GH₵",
  ...
  receiptFooterMessage: "Thank you for choosing SEDVIS HOTEL. We look forward to welcoming you again.",
  showHotelLogo: true,
  showQrCode: false,
