...
const PERMISSION_PHRASES: Record<string, string> = {
  ...
  "group_reservations.view": "View Group Reservations",
  "group_reservations.create": "Create Group Reservations",
  "group_reservations.edit": "Edit Group Reservations",
  "group_reservations.delete": "Delete Group Reservations",
  "group_reservations.manage": "Manage Group Reservations",
  "corporate_accounts.view": "View Corporate Accounts",
  "corporate_accounts.create": "Create Corporate Accounts",
  "corporate_accounts.edit": "Edit Corporate Accounts",
