...
const ACTION_LABEL_OVERRIDES: Record<string, string> = {
  ...
  [ActivityActionCodes.SHIFT_ACKNOWLEDGED]: "Shift handover acknowledged",
  [ActivityActionCodes.SHIFT_TASK_COMPLETED]: "Shift task completed",
  [ActivityActionCodes.SHIFT_ISSUE_RESOLVED]: "Shift issue resolved",
